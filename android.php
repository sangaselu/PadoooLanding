...
$query = "INSERT INTO AndroidForm (parentName, numberOfKids, phoneNumber, spendingRate, whatsapp, fbc, phoneCall, mail, parentEmail, kidEmail) VALUES('$parentName', $numberOfKids, '$phoneNumber', '$spendingRate', $whatsapp, $fbc, $phoneCall, $mail, '$parentEmail', '$kidEmail');";
